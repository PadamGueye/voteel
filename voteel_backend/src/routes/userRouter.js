...
router.post('/signup', allowIfLoggedin,grantAccess(defineUserRoles,['createAny'], 'profile') , userController.signup);router.post('/sendLink', allowIfLoggedin,grantAccess(defineUserRoles,['createAny'], 'link') , userController.sendLink);
