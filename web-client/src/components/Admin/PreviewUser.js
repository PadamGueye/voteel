    ...
    return(
        <div className={className}>
            ...
            </div>
            {
                ...
                (<>
                        <div className="mb-5">
                            <label htmlFor="sexe" className="block mb-2 text-sm text-primary-2 font-medium dark:text-white">Genre</label>
                            <span  className="h-10 w-[220px] md:w-[300px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">{GENRE[userData.sexe]}</span>
                        </div>
                        <div className="mb-5">
                            <label htmlFor="niveau" className="block mb-2 text-sm text-primary-2 font-medium dark:text-white">Niveau</label>
            ...
            }
            {
                ...
                (<>
                    <div className="mb-5">
                        ...
                        <span  className="h-10 w-[220px] md:w-[300px] shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">{userData.type}</span>
                    </div>
                </>)
            }
