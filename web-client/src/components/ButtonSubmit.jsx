const ButtonSubmit = ({onClick, inputState = "typing", isLoading = false, children = "Suivant"}) => {
    return(
        <button onClick={onClick} style={{opacity : inputState === "error" ? 0.7 : 1 }} className="bg-gradient-primary text-white w-[100%] py-3 shadow-lg rounded-md text-md " >
            {isLoading ? (
                <div role="status">
