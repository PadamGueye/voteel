    ...
    return(
        <MainLayout userRole={Types.ADMIN}>
            ...
            <div className={"flex flex-col items-center justify-start w-full h-screen"}>
                <MenuElections onRefresh={()=>{setRefresh(true)}} className={"flex justify-start md:flex-row h-[5%] items-center bg-blue-50 border-b bg-gray-5 border-gray-300 shadow-sm w-full gap-3 px-4"} />
