            ...
            <div className={"flex flex-col items-center justify-start w-full h-screen overflow-y-scroll bg-blue-50"}>
                ...
                {   !preview &&
                    <div className={"bg-white mt-10 w-[90%] h-[60%] p-6 rounded-xl border border-gray-300 shadow mb-16"}>
                        <AddElectionForm userData={userData} setUserData={setUserData} className={"flex flex-wrap h-[100%] justify-center items-center gap-5 overflow-y-scroll"}/>
                    </div>
                }
                {   preview &&
                    (<div className={"bg-white mt-10 w-[90%] h-[60%] p-6 rounded-xl border border-gray-300 shadow mb-16"}>
                        <PreviewElection setPreview={setPreview} userData={formatedData} className={"flex flex-wrap h-[100%] justify-center items-center gap-5 overflow-y-scroll"} />
                    </div>)
                }
